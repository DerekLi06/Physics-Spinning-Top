...
my_omega0 = slider(bind = omega0_set, min = 0, max = 4*pi, step = 0.1, value = omega0) 
...
while leave:
    ...
    if running:
        ...
        print("The thing equals: ",((2/I_perp)*(Energy-.5*I0*omega0**2-M*g*a*cos(theta)) - ((Lz-L*cos(theta)) / (I_perp*sin(theta)))**2))
        print("\n")
